class config:
    ...
    OUTPUT_STRIDE = 4  # 16 for training 8 for evaluation. demo_result
    ...
    PRETRAINED_MODEL_PATH = './model/152/resnet_v2_152.ckpt'
    #PRETRAINED_MODEL_PATH = './model/152/model.ckpt-172'

    # Epochs
    NUM_EPOCHS = 500        #10000 iterations = 1 epochs / batch size =1 / input shape = 512x512

    # Epoch_sizes
    NUM_EPOCHS_SIZE = 10000

    # Where to save the coco2017 dataset
    #ANNO_FILE = 'coco2017/annotations/ochuman_coco_format_val_range_0.00_1.00.json'
    #IMG_DIR = 'coco2017/images/'   ##images

    # ANNO_FILE = 'coco2017/annotations/COCO_MiniTrain2080_out.json'
    # IMG_DIR = 'coco2017/train2017/train2017/'
